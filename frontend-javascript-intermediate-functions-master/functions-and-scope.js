...
for (let i = 0; i < grades.length; i++) {
    avNumber = avNumber + grades[i];
}

console.log(avNumber / grades.length);
...
const result4 = averageGrade(grades);
...
const result7 = highestGrade(grades);
const result8 = highestGrade([6, 4, 5]);
const result9 = highestGrade([8,9, 4, 6, 10]);
